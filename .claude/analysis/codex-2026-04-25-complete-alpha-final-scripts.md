...
- `scripts/rag-live-test.sh`
  - Wraps `backend/tests/evaluation/run_ragas_evaluation.py --mode live --max-cases 127`.
  ...
  - Writes `backend/tests/evaluation/reports/ragas-live-<timestamp>.json` and `.md`.
  - Supports `--help` and network-free `--dry-run`.
...
- `bash -n scripts/alpha-smoke-comprehensive.sh scripts/rag-live-test.sh scripts/cloud-logging-verify.sh`
- `shellcheck scripts/alpha-smoke-comprehensive.sh scripts/rag-live-test.sh scripts/cloud-logging-verify.sh`
- `git diff --check`

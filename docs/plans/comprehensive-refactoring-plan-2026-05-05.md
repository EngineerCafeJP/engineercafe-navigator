...
| 627–792   | `POST /api/chat`, `POST /api/chat/stream`, `POST /api/agent/invoke` | `backend/api/chat.py`                                          | `chat`, `chat_stream`, `invoke_agent`                                                                                                                           |
...
| 969–1181  | `GET/POST /api/voice` と STT/TTS ヘルパ群                                | 同上 `backend/api/voice.py`                                      | `_get_stt_agent`, `_handle_stt`, `_handle_stt_warmup`, `voice_api`, `voice_get_api` 等                                                                           |

...
The QR PNGs are committed as provenance / source artifacts for the refreshed
deck. Current runtime code does not load them directly.
...
| --- | --- | --- |
| Owner | Unconfirmed; issue context suggests Engineer Cafe / operator-provided reception deck | Confirm operator ownership or redistribution permission before release |
...
| Generated by / exporter | Unconfirmed operator; PDF metadata shows LibreOffice Impress 26.2.2.2 export tool | Confirm the operator/export workflow in PR notes before release |

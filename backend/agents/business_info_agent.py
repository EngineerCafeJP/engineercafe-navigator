...
from backend.agents.business_info.cafe import BusinessInfoCafeMixin
from backend.agents.business_info.canonical import BusinessInfoCanonicalMixin
from backend.agents.business_info.matchers import BusinessInfoMatcherMixin
...
class BusinessInfoAgent(
    BusinessInfoCanonicalMixin, BusinessInfoCafeMixin, BusinessInfoMatcherMixin
):
    """営業情報エージェント

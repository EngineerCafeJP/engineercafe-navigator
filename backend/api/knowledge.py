...
from backend.api.knowledge_helpers import (
    _build_duplicate_conflict,
    _build_duplicate_conflict_detail,
    _build_knowledge_categories_response,
    _collapse_upload_metadata,
    _delete_rows_by_ids,
    _get_supabase,
    _is_unique_violation,
    _metadata_document_id,
    _normalize_api_metadata,
    _rollback_uploaded_chunks,
    _row_to_item,
    _sanitize_keyword,
    _select_document_rows,
    build_knowledge_preview,
)
from backend.api.knowledge_models import (
    KnowledgeCategoriesResponse,
    KnowledgeCategoriesStats as KnowledgeCategoriesStats,
...
def _build_knowledge_preview(
    *,
    ...
    return build_knowledge_preview(
        file_type=file_type,
        filename=filename,
        ...
        parse_markdown_fn=parse_markdown,
        parse_pdf_fn=parse_pdf,
        plan_upload_chunks_fn=plan_upload_chunks,
        upload_chunk_record_title_fn=upload_chunk_record_title,
    )

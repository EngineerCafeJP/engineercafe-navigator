...
from backend.utils.memory_maintenance import MemoryMaintenanceMixin
from backend.utils.memory_observability import (
    _AGENT_MEMORY_SESSION_COLUMN,
    _duration_ms,
    _log_memory_event_safely,
)
from backend.utils.memory_ranking import MemoryRankingMixin
...
class SimplifiedMemoryHelper(MemoryRankingMixin, MemoryMaintenanceMixin):
    """

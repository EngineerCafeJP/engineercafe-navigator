...
export const kioskSettingsLabels = {
  ja: {
    ...
    ttsSpeedTitle: '音声スピード（ナビゲーターの発話速度）',
    ttsSpeedSlow: '遅い',
    ttsSpeedFast: '速い',
    ttsSpeedHint: 'piper-plus の合成話速を調整します（1.0=標準）。',
  ...
  en: {
    ...
    ttsSpeedTitle: 'Speech speed (navigator voice)',
    ttsSpeedSlow: 'Slow',
    ttsSpeedFast: 'Fast',
    ttsSpeedHint: 'Adjusts piper-plus synthesis speed (1.0 = normal).',
